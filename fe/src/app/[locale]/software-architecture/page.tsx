    ...
    return (
        <main className="relative bg-white min-h-screen font-sans">
            ...
            <section className="pt-32 lg:pt-40 overflow-hidden bg-gradient-to-b from-slate-50 to-white">
                <div className="sa-hero-1 absolute top-0 right-0 -mr-20 -mt-20 max-w-80 md:max-w-96 h-96 bg-indigo-500/5 rounded-full blur-3xl"></div>
            ...
            <section className="pb-24 bg-white" id="services">
