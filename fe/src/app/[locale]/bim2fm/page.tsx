...
export default function BIM2FM() {
    const t = useTranslations('pages.bim2fm');
    useEffect(() => {
    ...
    return (
        <main className="relative bg-white min-h-screen font-sans">
            ...
            <section className="pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-gradient-to-b from-slate-50 to-white">
                <div className="bim2fm-hero-1 absolute top-0 right-0 -mr-20 -mt-20 max-w-80 md:max-w-96 h-96 bg-sky-blue/5 rounded-full blur-3xl"></div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-4 lg:gap-6 h-auto md:h-[600px]" data-motion-stagger="0.1">
                        ...
                        <a href="#data-sync" {...withDelay(motionConfig.slideUp, 0.2)} className="group relative md:col-span-2 md:row-span-2 rounded-3xl overflow-hidden shadow-lg border border-sky-blue/10 bg-white p-8 flex flex-col justify-between hover:scale-[1.01] hover:shadow-2xl transition-all duration-300">
                            <div>
                                ...
                                <h3 className="text-3xl font-display font-medium text-navy-blue mb-2 group-hover:text-sky-blue transition-colors">{t('grid.sync.title')}</h3>
                                <p className="text-neutral-gray max-w-sm">{t('grid.sync.description')}</p>
                            </div>
                            <div className="flex items-center text-sky-blue font-semibold text-sm mt-4 group-hover:translate-x-2 transition-transform">
                                {t('grid.sync.cta')} <span className="ml-2">→</span>
                            </div>
                        </a>
                        ...
                        <a href="#quality-control" {...withDelay(motionConfig.scaleIn, 0.3)} className="group relative md:col-span-1 md:row-span-1 rounded-3xl overflow-hidden shadow-md border border-sky-blue/10 bg-slate-50 p-6 flex flex-col justify-between hover:scale-[1.02] hover:shadow-xl transition-all duration-300 hover:bg-white">
                            ...
                            <div>
                                <h4 className="text-lg font-bold text-navy-blue mb-1">{t('grid.quality.title')}</h4>
                                <p className="text-xs text-neutral-gray">{t('grid.quality.description')}</p>
                            </div>
                        </a>
                        ...
                        <a href="#user-friendly" {...withDelay(motionConfig.slideRight, 0.4)} className="group relative md:col-span-1 md:row-span-2 rounded-3xl overflow-hidden shadow-lg border border-sky-blue/10 bg-sky-blue/5 p-6 flex flex-col justify-between hover:scale-[1.02] hover:shadow-xl transition-all duration-300 hover:bg-sky-blue/10">
                            ...
                            <div>
                                ...
                                <h3 className="text-xl font-display font-medium text-navy-blue mb-2">{t('grid.userFriendly.title')}</h3>
                                <p className="text-sm text-neutral-gray leading-relaxed">
                                    {t('grid.userFriendly.description')}
                                </p>
                            </div>
                            <div className="mt-4">
                                <span className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-white text-[10px] font-bold uppercase tracking-wide text-sky-blue shadow-sm">
                                    {t('grid.userFriendly.badge')}
                                </span>
                            </div>
                        </a>

                        {/* Data Filtering */}
                        <a href="#filtering" {...withDelay(motionConfig.scaleIn, 0.4)} className="group relative md:col-span-1 md:row-span-1 rounded-3xl overflow-hidden shadow-md border border-sky-blue/10 bg-slate-50 p-6 flex flex-col justify-between hover:scale-[1.02] hover:shadow-xl transition-all duration-300 hover:bg-white">
                            <div className="flex justify-between items-start">
                            ...
                            <div>
                                <h4 className="text-lg font-bold text-navy-blue mb-1">{t('grid.filtering.title')}</h4>
                                <p className="text-xs text-neutral-gray">{t('grid.filtering.description')}</p>
                            </div>
                        </a>

                        {/* Contact CTA */}
                        <Link href={`/${(typeof window !== 'undefined' ? window.location.pathname.split('/')[1] : 'en')}/contact`} {...withDelay(motionConfig.slideUp, 0.5)} className="md:col-span-1 md:row-span-1 rounded-3xl overflow-hidden shadow-md border border-navy-blue/10 bg-gradient-to-br from-white to-sky-blue/5 p-6 flex flex-col justify-between hover:scale-[1.02] transition-all duration-300">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-xl bg-navy-blue flex items-center justify-center text-white">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-navy-blue">{t('grid.contact.title')}</h3>
                                    <p className="text-xs text-neutral-gray uppercase tracking-widest">{t('grid.contact.subtitle')}</p>
                                </div>
                            </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div {...motionConfig.slideLeft} className="bim2fm-features-slideLeft">
                            <h2 className="font-display text-4xl lg:text-5xl text-navy-blue mb-6">
                                {t('dataSync.title')} <span className="text-sky-blue">{t('dataSync.titleHighlight')}</span>
                            </h2>
                            ...
                            <ul className="space-y-4 mb-8">
                                <li className="flex items-start">
                                    ...
                                    <span className="text-neutral-gray">{t('dataSync.points.0')}</span>
                                </li>
                                <li className="flex items-start">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-sky-blue mr-3 mt-1 flex-shrink-0"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg>
                                    <span className="text-neutral-gray">{t('dataSync.points.1')}</span>
                                </li>
                                <li className="flex items-start">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-sky-blue mr-3 mt-1 flex-shrink-0"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg>
                                    <span className="text-neutral-gray">{t('dataSync.points.2')}</span>
                                </li>
                            </ul>
                        </div>
                        <div {...motionConfig.slideRight} className="bim2fm-features-slideRight relative rounded-3xl overflow-hidden shadow-2xl bg-slate-50 border border-sky-blue/10 p-8">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="text-center p-6 bg-white rounded-lg border border-sky-blue/10">
                                    ...
                                    <p className="text-sm font-bold text-neutral-gray">{t('dataSync.bimModel')}</p>
                                </div>
                                <div className="text-center p-6 bg-white rounded-lg border border-sky-blue/10">
                                    ...
                                    <p className="text-sm font-bold text-neutral-gray">{t('dataSync.fmSystem')}</p>
                                </div>
                                <div className="col-span-2 flex items-center justify-center p-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs font-bold text-sky-blue uppercase">{t('dataSync.syncBadge')}</span>
            ...
            <section className="py-24 bg-slate-50 border-y border-sky-blue/10" id="quality-control">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16" {...motionConfig.fadeIn}>
                        <span className="text-sky-blue font-bold tracking-widest uppercase text-xs mb-3 block">{t('qualityControl.badge')}</span>
                        <h2 className="font-display text-4xl lg:text-5xl text-navy-blue mb-6">{t('qualityControl.title')}</h2>
                    ...
                    <div className="relative bg-white rounded-3xl p-8 lg:p-12 shadow-xl border border-sky-blue/10 overflow-hidden" {...withDelay(motionConfig.slideUp, 0.2)}>
                        <div className="grid lg:grid-cols-3 gap-8">
                            <div className="flex gap-4 items-start">
                                ...
                                <div>
                                    <h4 className="font-bold text-navy-blue mb-2">{t('qualityControl.features.visual.title')}</h4>
                                    <p className="text-sm text-neutral-gray">{t('qualityControl.features.visual.description')}</p>
                                </div>
                            </div>

                            <div className="flex gap-6 p-6 rounded-2xl bg-purple-50/50 border border-purple-100 transition-all hover:shadow-md">
                                ...
                                <div>
                                    <h4 className="font-bold text-navy-blue mb-2">{t('qualityControl.features.validation.title')}</h4>
                                    <p className="text-sm text-neutral-gray">{t('qualityControl.features.validation.description')}</p>
                                </div>
                            </div>

                            <div className="flex gap-6 p-6 rounded-2xl bg-teal-50/50 border border-teal-100 transition-all hover:shadow-md">
                                ...
                                <div>
                                    <h4 className="font-bold text-navy-blue mb-2">{t('qualityControl.features.detection.title')}</h4>
                                    <p className="text-sm text-neutral-gray">{t('qualityControl.features.detection.description')}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div {...motionConfig.slideLeft}>
                            ...
                            <h2 className="font-display text-4xl lg:text-5xl text-navy-blue mb-6">{t('filtering.title')}</h2>
                            <p className="text-lg text-neutral-gray mb-8 leading-relaxed">
                                {t('filtering.description')}
                            </p>
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-navy-blue">{t('filtering.features.custom.title')}</h4>
                                        <p className="text-sm text-neutral-gray">{t('filtering.features.custom.description')}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-navy-blue">{t('filtering.features.selective.title')}</h4>
                                        <p className="text-sm text-neutral-gray">{t('filtering.features.selective.description')}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-navy-blue">{t('filtering.features.userDriven.title')}</h4>
                                        <p className="text-sm text-neutral-gray">{t('filtering.features.userDriven.description')}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="bg-white rounded-xl p-6 border border-sky-blue/10">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3 text-sm border-b border-sky-blue/10 pb-3">
                                        ...
                                        <span className="font-bold text-xs text-navy-blue uppercase tracking-wider">{t('filtering.status.title')}</span>
                                    </div>
                                    <div className="space-y-3">
                                        <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                            <span className="text-xs text-neutral-gray">{t('filtering.status.detailLevel')}</span>
                                            <span className="text-xs text-navy-blue font-bold">{t('filtering.status.high')}</span>
                                        </div>
                                        <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                            <span className="text-xs text-neutral-gray">{t('filtering.status.elements')}</span>
                                            <span className="text-xs text-navy-blue font-bold">{t('filtering.status.elementsValue')}</span>
                                        </div>
                                        <div className="flex items-center justify-between p-3 bg-sky-blue/5 rounded-lg border border-sky-blue/20">
                                            <span className="text-xs text-neutral-gray">{t('filtering.status.status')}</span>
                                            <span className="text-xs text-sky-blue font-bold">{t('filtering.status.inProgress')}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section className="py-24 bg-slate-50" id="benefits">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center mb-16" {...motionConfig.fadeIn}>
                        <h2 className="font-display text-4xl lg:text-5xl text-navy-blue mb-6">{t('benefits.title')}</h2>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8" data-motion-stagger="0.1">
                        <div {...motionConfig.slideUp} className="bg-white p-6 rounded-2xl shadow-lg border border-sky-blue/10 hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <h3 className="font-bold text-lg text-navy-blue mb-2">{t('benefits.items.commissioning.title')}</h3>
                            <p className="text-sm text-neutral-gray">{t('benefits.items.commissioning.description')}</p>
                        </div>
                        ...
                        <div {...motionConfig.slideUp} className="bg-white p-6 rounded-2xl shadow-lg border-2 border-sky-blue/20 hover:-translate-y-2 transition-transform duration-300 relative">
                            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-sky-blue text-white text-[10px] font-bold px-2 py-0.5 rounded-full uppercase">{t('benefits.items.maintenance.badge')}</div>
                            ...
                            <h3 className="font-bold text-lg text-navy-blue mb-2">{t('benefits.items.maintenance.title')}</h3>
                            <p className="text-sm text-neutral-gray">{t('benefits.items.maintenance.description')}</p>
                        </div>
                        ...
                        <div {...motionConfig.slideUp} className="bg-white p-6 rounded-2xl shadow-lg border border-sky-blue/10 hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <h3 className="font-bold text-lg text-navy-blue mb-2">{t('benefits.items.digitalTwin.title')}</h3>
                            <p className="text-sm text-neutral-gray">{t('benefits.items.digitalTwin.description')}</p>
                        </div>
                        ...
                        <div {...motionConfig.slideUp} className="bg-white p-6 rounded-2xl shadow-lg border border-sky-blue/10 hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <h3 className="font-bold text-lg text-navy-blue mb-2">{t('benefits.items.coordination.title')}</h3>
                            <p className="text-sm text-neutral-gray">{t('benefits.items.coordination.description')}</p>
                        </div>
                    </div>
                </div>
            </section>
