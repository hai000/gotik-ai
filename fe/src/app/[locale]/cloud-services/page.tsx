...
export default function CloudServices() {
    ...
    const solutionCards = [
        ...
        {
            key: "migration",
            iconWrapperClassName: "w-14 h-14 bg-purple-50 rounded-2xl flex items-center justify-center text-purple-600 mb-6 group-hover:bg-purple-600 group-hover:text-white transition-colors",
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" /></svg>
        },
        {
            key: "native",
            iconWrapperClassName: "w-14 h-14 bg-teal-50 rounded-2xl flex items-center justify-center text-teal-600 mb-6 group-hover:bg-teal-600 group-hover:text-white transition-colors",
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>
        },
        {
            key: "multiCloud",
            iconWrapperClassName: "w-14 h-14 bg-orange-50 rounded-2xl flex items-center justify-center text-orange-600 mb-6 group-hover:bg-orange-600 group-hover:text-white transition-colors",
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>
        },
        {
            key: "security",
            iconWrapperClassName: "w-14 h-14 bg-red-50 rounded-2xl flex items-center justify-center text-red-600 mb-6 group-hover:bg-red-600 group-hover:text-white transition-colors",
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
        },
        {
            key: "optimization",
            iconWrapperClassName: "w-14 h-14 bg-green-50 rounded-2xl flex items-center justify-center text-green-600 mb-6 group-hover:bg-green-600 group-hover:text-white transition-colors",
    ...
    const approachCards = [
        {
            key: "strategy",
            step: t('approach.steps.strategy.step'),
            title: t('approach.steps.strategy.title'),
            desc: t('approach.steps.strategy.description'),
            color: "bg-blue-600"
        },
        {
            key: "migration",
            step: t('approach.steps.migration.step'),
            title: t('approach.steps.migration.title'),
            desc: t('approach.steps.migration.description'),
            color: "bg-sky-blue"
        },
        {
            key: "optimization",
            step: t('approach.steps.optimization.step'),
            title: t('approach.steps.optimization.title'),
            desc: t('approach.steps.optimization.description'),
            color: "bg-teal-500"
        }
    ];
    ...
    const platformCards = [
        {
            key: "aws",
            title: t('platforms.aws.title'),
            desc: t('platforms.aws.description'),
            iconWrapperClassName: "w-20 h-20 bg-orange-50 rounded-2xl flex items-center justify-center text-orange-600 mx-auto mb-6",
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
        },
        {
            key: "azure",
            title: t('platforms.azure.title'),
            desc: t('platforms.azure.description'),
            iconWrapperClassName: "w-20 h-20 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-600 mx-auto mb-6",
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>
        },
        {
            key: "gcp",
            title: t('platforms.gcp.title'),
            desc: t('platforms.gcp.description'),
            iconWrapperClassName: "w-20 h-20 bg-red-50 rounded-2xl flex items-center justify-center text-red-600 mx-auto mb-6",
    ...
    const benefitCards = [
        {
            key: "certified",
            title: t('whyChoose.items.certified.title'),
            desc: t('whyChoose.items.certified.description'),
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>,
            iconWrapperClassName: "w-16 h-16 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform"
        },
        {
            key: "custom",
            title: t('whyChoose.items.custom.title'),
            desc: t('whyChoose.items.custom.description'),
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" /></svg>,
            iconWrapperClassName: "w-16 h-16 bg-sky-blue/10 text-sky-blue rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform"
        },
        {
            key: "security",
            title: t('whyChoose.items.security.title'),
            desc: t('whyChoose.items.security.description'),
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z" /></svg>,
            iconWrapperClassName: "w-16 h-16 bg-red-50 text-red-500 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform"
        },
        {
            key: "support",
            title: t('whyChoose.items.support.title'),
            desc: t('whyChoose.items.support.description'),
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {solutionCards.map((item, index) => (
                            <FeatureCard
                                key={item.key}
                                title={t(`solutions.items.${item.key}.title`)}
                                description={t(`solutions.items.${item.key}.description`)}
                                icon={item.icon}
                                motion={withDelay(motionConfig.slideUp, index * 0.1)}
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {platformCards.map((item, index) => (
                            <FeatureCard
                                ...
                                icon={item.icon}
                                motion={withDelay(motionConfig.slideUp, index * 0.1)}
                                cardClassName="bg-white p-8 rounded-3xl border border-sky-blue/10 shadow-sm hover:shadow-xl transition-all duration-300 text-center"
                                iconWrapperClassName={item.iconWrapperClassName}
                        ...
                        <div className="grid lg:grid-cols-3 gap-12 relative z-10">
                            {approachCards.map((item, index) => (
                                <FeatureCard
                                    ...
                                    description={item.desc}
                                    icon={
                                        <div className={`w-12 h-12 ${item.color} text-white rounded-full flex items-center justify-center font-bold shadow-lg`}>
                                            {item.step}
                                        </div>
                                    }
                                    motion={withDelay(motionConfig.slideUp, index * 0.1)}
                                    cardClassName="bg-white p-8 rounded-3xl border border-sky-blue/10 shadow-sm hover:shadow-xl transition-all duration-300"
                                    iconWrapperClassName="mb-6 mx-auto lg:mx-0"
                                />
                            ))}
                        </div>
                    </div>
