...
export default function DataArchitecture() {
    ...
    const trustReasonCards = [
        {
            key: "expertise",
            title: t('trust.reasons.expertise.title'),
            description: t('trust.reasons.expertise.description'),
            iconWrapperClassName: "w-16 h-16 rounded-2xl bg-teal-500/20 flex items-center justify-center text-teal-400 mx-auto mb-6",
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>
        },
        {
            key: "holistic",
            title: t('trust.reasons.holistic.title'),
            description: t('trust.reasons.holistic.description'),
            iconWrapperClassName: "w-16 h-16 rounded-2xl bg-sky-blue/20 flex items-center justify-center text-sky-blue mx-auto mb-6",
        ...
        {
            key: "sustainable",
            title: t('trust.reasons.sustainable.title'),
            description: t('trust.reasons.sustainable.description'),
            iconWrapperClassName: "w-16 h-16 rounded-2xl bg-green-500/20 flex items-center justify-center text-green-400 mx-auto mb-6",
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg>
        },
        {
            key: "enterprise",
            title: t('trust.reasons.enterprise.title'),
            description: t('trust.reasons.enterprise.description'),
            iconWrapperClassName: "w-16 h-16 rounded-2xl bg-purple-500/20 flex items-center justify-center text-purple-400 mx-auto mb-6",
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="8" height="8" x="3" y="3" rx="2" /><path d="M7 11v4a2 2 0 0 0 2 2h4" /><rect width="8" height="8" x="13" y="13" rx="2" /></svg>
        }
    ];
    ...
    const challengeCards = [
        {
            key: "transparency",
            title: t('challenges.items.transparency.title'),
            description: t('challenges.items.transparency.description'),
            iconWrapperClassName: "w-12 h-12 rounded-xl bg-teal-100 flex items-center justify-center text-teal-600 mb-4",
        ...
        {
            key: "silos",
            title: t('challenges.items.silos.title'),
            description: t('challenges.items.silos.description'),
            iconWrapperClassName: "w-12 h-12 rounded-xl bg-orange-100 flex items-center justify-center text-orange-600 mb-4",
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="8" height="8" x="3" y="3" rx="2" /><path d="M7 11v4a2 2 0 0 0 2 2h4" /><rect width="8" height="8" x="13" y="13" rx="2" /></svg>
        },
        {
            key: "integration",
            title: t('challenges.items.integration.title'),
            description: t('challenges.items.integration.description'),
            iconWrapperClassName: "w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center text-sky-blue mb-4",
        ...
        {
            key: "compliance",
            title: t('challenges.items.compliance.title'),
            description: t('challenges.items.compliance.description'),
            iconWrapperClassName: "w-12 h-12 rounded-xl bg-red-100 flex items-center justify-center text-red-600 mb-4",
        ...
        {
            key: "delivery",
            title: t('challenges.items.delivery.title'),
            description: t('challenges.items.delivery.description'),
            iconWrapperClassName: "w-12 h-12 rounded-xl bg-purple-100 flex items-center justify-center text-purple-600 mb-4",
            cardClassName: "bg-gradient-to-br from-slate-50 to-white rounded-3xl p-8 border border-sky-blue/10 md:col-span-2 lg:col-span-2",
    ...
    return (
        <main className="relative bg-white min-h-screen w-full overflow-x-hidden font-sans">
            <Navbar />

            {/* Hero Section */}
            <section className="pt-32 lg:pt-40 overflow-hidden bg-gradient-to-b from-slate-50 to-white">
                <div className="da-hero-1 absolute top-0 right-0 -mr-20 -mt-20 h-96 bg-teal-500/5 rounded-full blur-3xl"></div>
            ...
            {/* Challenges Section */}
            <section className="pb-24 bg-white" id="challenges">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {challengeCards.map((item, index) => (
                            <FeatureCard
                                ...
                                cardClassName={item.cardClassName ?? "bg-gradient-to-br from-slate-50 to-white rounded-3xl p-8 border border-sky-blue/10"}
                                iconWrapperClassName={item.iconWrapperClassName}
                                titleClassName="font-display text-lg text-navy-blue mb-2"
                                descriptionClassName="text-neutral-gray text-sm"
                            />
                        ))}
                    </div>
                </div>
            ...
            <section className="py-24 bg-navy-blue text-white" id="why-trust">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {trustReasonCards.map((item, index) => (
                            <FeatureCard
                                key={item.key}
                                title={item.title}
                                description={item.description}
                                icon={item.icon}
                                motion={withDelay(motionConfig.slideUp, index * 0.1)}
                                cardClassName="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 text-center"
                                iconWrapperClassName={item.iconWrapperClassName}
                                titleClassName="font-display text-xl mb-4 text-white"
            ...
            <FAQSection
                ...
                itemMotion={() => motionConfig.slideUp}
